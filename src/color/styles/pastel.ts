...
export const pastelStyle: StyleConfig = {
  dark: {
    ...
    'sideBarSectionHeader.border': { lightness: 0.34, chromaFactor: 0.5 },
  },
  light: {
    ...
    'sideBarSectionHeader.border': { lightness: 0.82, chromaFactor: 0.5 },
  },
  hcDark: {
    ...
    'titleBar.border': { lightness: 0.24, chromaFactor: 0.6 },
    'statusBar.background': { lightness: 0.26, chromaFactor: 0.65 },
    'statusBar.foreground': { lightness: 0.96, chromaFactor: 0.1 },
    'statusBar.border': { lightness: 0.26, chromaFactor: 0.65 },
    'statusBar.focusBorder': { lightness: 0.26, chromaFactor: 0.65 },
    'activityBar.background': { lightness: 0.18, chromaFactor: 0.55 },
    'activityBar.foreground': { lightness: 0.94, chromaFactor: 0.1 },
    'activityBar.activeBackground': { lightness: 0.18, chromaFactor: 0.55 },
    'activityBar.activeBorder': { lightness: 0.18, chromaFactor: 0.55 },
    'sideBar.background': { lightness: 0.15, chromaFactor: 0.55 },
    'sideBar.foreground': { lightness: 0.94, chromaFactor: 0.1 },
    'sideBar.border': { lightness: 0.15, chromaFactor: 0.55 },
    ...
    'sideBarSectionHeader.border': { lightness: 0.18, chromaFactor: 0.55 },
  },
  hcLight: {
    ...
    'sideBarSectionHeader.border': { lightness: 0.92, chromaFactor: 0.55 },
  },
};
