...
export const mutedStyle: StyleConfig = {
  dark: {
    ...
    'sideBarSectionHeader.border': { lightness: 0.3, chromaFactor: 0.28 },
  },
  light: {
    ...
    'titleBar.border': { lightness: 0.78, chromaFactor: 0.32 },
    'statusBar.background': { lightness: 0.75, chromaFactor: 0.35 },
    'statusBar.foreground': { lightness: 0.18, chromaFactor: 0.1 },
    'statusBar.border': { lightness: 0.75, chromaFactor: 0.35 },
    'statusBar.focusBorder': { lightness: 0.75, chromaFactor: 0.35 },
    'activityBar.background': { lightness: 0.84, chromaFactor: 0.28 },
    'activityBar.foreground': { lightness: 0.2, chromaFactor: 0.08 },
    'activityBar.activeBackground': { lightness: 0.84, chromaFactor: 0.28 },
    'activityBar.activeBorder': { lightness: 0.84, chromaFactor: 0.28 },
    'sideBar.background': { lightness: 0.87, chromaFactor: 0.28 },
    'sideBar.foreground': { lightness: 0.2, chromaFactor: 0.08 },
    'sideBar.border': { lightness: 0.87, chromaFactor: 0.28 },
    ...
    'sideBarSectionHeader.border': { lightness: 0.84, chromaFactor: 0.28 },
  },
  hcDark: {
    ...
    'sideBarSectionHeader.border': { lightness: 0.14, chromaFactor: 0.32 },
  },
  hcLight: {
    ...
    'sideBarSectionHeader.border': { lightness: 0.94, chromaFactor: 0.32 },
  },
};
