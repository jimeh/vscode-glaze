...
/**
 * Duotone color scheme - base hue + complement split across UI elements.
 *
 * Title bar and activity bar use the base hue, while the status bar
 * uses the complementary hue (180° offset). Creates a balanced,
 * harmonious two-color palette per workspace.
 */
